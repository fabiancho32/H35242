...
catch(ParseException e)
{
 ...
 System.err.println(e.getMessage());
  ...
  static final public void declaracion_opcional() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 16:{
      jj_consume_token(16);
      break;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1600,0x1600,0x11000,0x11000,0x600,0x10000,0x11000,0x80,0x100,0x1820,};
   }
