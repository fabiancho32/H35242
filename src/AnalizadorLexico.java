 ...
 */
  ...
  static final public void TokenElement() throws ParseException {Token pieza;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SUMA:{
      /*OPERADORES*/
...
numero++;
    ...
    case CONDICIONALFINSI:{
      pieza = jj_consume_token(CONDICIONALFINSI);
numero++;
...
numero++;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xfe7fffc0,0xfe7fffc0,};
   }
